package br.com.senaigo.helpdesk.api.security.config;
...
import br.com.senaigo.helpdesk.api.security.jwt.JwtAuthenticationEntryPoint;
import br.com.senaigo.helpdesk.api.security.jwt.JwtAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(authenticationEntryPoint).and()
				...
				.antMatchers(HttpMethod.GET, "/", "/*.html", "/*.com", "/favicon.ico", "/**/*.css", "/**/*.html", "/**/*.com", "/**/*.js")
